...
const FertilizerCard = ({ herbs}) => {

  
  const { price, name, image, type,scientific_name, available } =  herbs;
  ...
  const handleToggleAvailable = async () => {
    try {
      ...
      await axios.patch(`http://localhost:8080/fertilizers/${herbs._id}/toggleAvailableherbs`, { available: !isAvailable });
    ...
    <div className='col-md-4 col-sm-6 col-lg-3 adminpro'>
        <div className='adminoverall'>
            ...
            <div className='adminproduct-content'>
                ...
                <p className='manufacturer'>Scitific Name: {scientific_name}</p>
