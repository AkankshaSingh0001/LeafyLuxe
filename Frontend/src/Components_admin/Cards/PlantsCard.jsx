...
const FertilizerCard = ({plant}) => {

  
  const { price, name, image, manufacturer, type , available} =  plant;
  ...
  const handleToggleAvailable = async () => {
    try {
      ...
      await axios.patch(`http://localhost:8080/fertilizers/${plant._id}/toggleAvailableplants`, { available: !isAvailable });
