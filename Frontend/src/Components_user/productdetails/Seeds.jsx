...
const detail=()=>{
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8080/cosdetseed/${id}`)
      .then(response => {
  ...
  const { price, name, image, description,planting_instructions,manufacturer,city,cp} = seed;
  const cpp=cp;
            ...
            <div className='row'>
                ...
                <div className='col-6'>
                    <div className='row'>
                        ...
                        <div className='col-12'>
                            Planting instruction: <span>{planting_instructions}</span><br></br>
