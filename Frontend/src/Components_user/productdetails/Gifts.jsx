...
const detail=()=>{
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8080/cosdetgift/${id}`)
      .then(response => {
  ...
  const { price, name, image, description,manufacturer,city,cp} = gift;
            ...
            <div className='row'>
                ...
                <div className='col-6'>
                    <div className='row'>
                        ...
                        <div className='col-12'>
                            Material: <span>Made with real and frash flowers</span><br></br>
