...
const EditAccessoryForm = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/accessories/${id}`)
            .then(response => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`http://localhost:8080/accessories/${id}`, formData)
            .then(response => {
    ...
    return (
        <form onSubmit={handleSubmit} className="container mt-4">
            ...
            <div className="mb-3">
                ...
                <input type="text" name="material" value={formData.material} onChange={handleChange} className="form-control" />
            </div>
            <div className="mb-3">
