...
const EditPlantForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`http://localhost:8080/plants/${id}`, formData)
            .then(response => {
    ...
    return (
        <form onSubmit={handleSubmit} className="container mt-4">
            ...
            <div className="mb-3">
                <label className="form-label">Core Instructions</label>
                <input type="text" name="core_instructions" value={formData.core_instructions} onChange={handleChange} className="form-control" />
            </div>
            <div className="mb-3">
